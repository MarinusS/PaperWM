...
const actions = {
    ...
    workspaces: [
        ...
        'switch-first-workspace',
        'switch-second-workspace',
        'switch-third-workspace',
        'switch-fourth-workspace',
        'switch-fifth-workspace',
        'switch-sixth-workspace',
        'switch-seventh-workspace',
        'switch-eighth-workspace',
        'switch-ninth-workspace',
        'switch-tenth-workspace',
        'move-up-workspace',
        'move-down-workspace',
